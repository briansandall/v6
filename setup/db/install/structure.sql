...
CREATE TABLE IF NOT EXISTS `CubeCart_documents` (
	...
	`doc_title_short` VARCHAR(200) NOT NULL DEFAULT '' COMMENT 'Used for additional product info modal dialogue link',
...
CREATE TABLE IF NOT EXISTS `CubeCart_inventory` (
  ...
  `product_length` decimal(10,3) DEFAULT NULL COMMENT 'Product Length',
  `product_height` decimal(10,3) DEFAULT NULL COMMENT 'Product Height',
  ...
  `lead_time_min` TINYINT UNSIGNED NULL DEFAULT NULL COMMENT 'Overrides manufacturer minimum lead time',
  `lead_time_max` TINYINT UNSIGNED NULL DEFAULT NULL COMMENT 'Overrides manufacturer maximum lead time',
  ...
  `info_doc_id` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'ID of document for modal dialogue box',
...
CREATE TABLE IF NOT EXISTS `CubeCart_option_assign` (
	...
	`option_length` decimal(10,2) NOT NULL DEFAULT '0.00',
	`option_height` decimal(10,2) NOT NULL DEFAULT '0.00',
	`option_width` decimal(10,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `CubeCart_option_matrix` (
  ...
  `set_enabled` tinyint(1) unsigned NOT NULL DEFAULT 1 COMMENT 'Whether this combination is enabled',
